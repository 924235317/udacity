...
def matxMultiply(A, B):
    ...
    for row in range(row_A):
        for col in range(col_B):
            res[row][col] = sum([x*y for x, y in zip(A[row], bt[col])]) 
...
#     0 & -\frac{3}{7} & \frac{57}{7} & \frac{12}{7}\end{bmatrix}$
# 
# $ --> \begin{bmatrix}
...
#     0 & \frac{13}{2} & -\frac{17}{2} & \frac{11}{10} \\
#     0 & \frac{13}{2} & -\frac{17}{2} & \frac{1}{10}\end{bmatrix}$
#     
# $ --> \begin{bmatrix}
#     1 & 0 & \frac{2}{13} & -\frac{12}{65} \\
#     0 & 1 & -\frac{17}{13} & \frac{11}{65} \\
#     0 & 0 & 0 & 1 \end{bmatrix}$
#     
# $ --> \begin{bmatrix}
#     1 & 0 & \frac{2}{13} & 0 \\
...
""" Gaussian Jordan 方法求解 Ax = b.
    ...
    返回None，如果 A 为奇异矩阵
"""
#参考了https://www.cnblogs.com/zingp/p/8011295.html
...
def gj_Solve(A, b, decPts=4, epsilon = 1.0e-16):
    ...
    matxRound(M)
    res = [[value] for value in transpose(M)[-1]]
    #print res
    return res
